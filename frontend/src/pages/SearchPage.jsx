...
const SearchPage = () => {
    ...
    const handleTabClick = (tab)=>{
        ...
        setResults([]);  //setting the result array empty when we change the content type in the search page
    }
  ...
  return (
    <div className="bg-black min-h-screen text-white">
        ...
        <div className="container mx-auto px-4 py-8">
            {/* A div for buttons to select particular search type */}
            ...
            <form className="flex gap-2 mb-8 max-w-2xl mx-auto items-stretch" onSubmit={handleSearch}>
                <input 
                    type="text" 
                    value={searchTerm}
