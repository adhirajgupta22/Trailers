...
const AuthScreen = () => {
  ...
  return (
    <div className='hero-bg relative'>
        ...
        <div className='text-white flex flex-col items-center justify-center text-center max-w-6xl mx-auto py-40'>
            ...
            <form onSubmit={handleFormSubmit} className='flex flex-col md:flex-row gap-4 w-1/2'>
                <input 
                    ...
                    className='bg-black/60 border border-gray-700 p-2 rounded flex-1'
                    value={email}
        ...
        {/* separator */}
        <div className='h-2 w-full bg-[#232323] area-hidden:true'></div>

        {/* 1st section */}
        <div className='text-white py-10 bg-black/90'>
        ...
        <div className='text-white py-10 bg-black'>
                <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
                    ...
                    <div className='flex-1 md:text-left text-center'>
                        <h2 className='text-4xl md:text-5xl font-extrabold mb-4 text-balance'>Downloand your shows to watch offline</h2>
        ...
        <div className='py-10 bg-black text-white'>
            <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
                ...
                <div className='flex-1 relative overflow-hidden'>
                    ...
                    <video
                        //little bit of responsiveness in the video has to be improved
                        className='absolute top-2 left-1/2 -translate-x-1/2 h-4/6 z-10 w-[200px] sm:w-[350px]'  
                        playsInline
                        autoPlay={true}
                        muted
                        loop
        ...
        {/* 4th section */}
        <div className='py-10 bg-black/90 text-white'>
